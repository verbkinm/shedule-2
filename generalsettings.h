...
#define SHARE_FILE_MAIN_SHEDULE_TODAY QString("share"+QString(PATH_SPLITER)+"расписание уроков"+PATH_SPLITER+"на сегодня"+PATH_SPLITER+"izmenenie.html")
#define SHARE_DIR_MAIN_SHEDULE_TODAY QString("share"+QString(PATH_SPLITER)+"расписание уроков"+PATH_SPLITER+"на сегодня")
#define SHARE_FILE_MAIN_SHEDULE_YESTERDAY QString("share"+QString(PATH_SPLITER)+"расписание уроков"+PATH_SPLITER+"на завтра"+PATH_SPLITER+"izmenenie.html")
#define SHARE_DIR_MAIN_SHEDULE_YESTERDAY QString("share"+QString(PATH_SPLITER)+"расписание уроков"+PATH_SPLITER+"на завтра")
#define SHARE_ARCHIVE_PATH QString("share"+QString(PATH_SPLITER)+"расписание уроков"+QString(PATH_SPLITER)+"архив")

#define LOCAL_FILE_MAIN_SHEDULE_TODAY QString("local"+QString(PATH_SPLITER)+"расписание уроков"+PATH_SPLITER+"на сегодня"+PATH_SPLITER+"сегодня.xml")
#define LOCAL_FILE_MAIN_SHEDULE_YESTERDAY QString("local"+QString(PATH_SPLITER)+"расписание уроков"+PATH_SPLITER+"на завтра"+PATH_SPLITER+"на завтра.xml")
